...
Original file is located at
    https://colab.research.google.com/drive/1l3tAMleS9ndtHPMdPsGNXT67BmwPmNgD
...
# The code was adapted from file SimCLR/loss/nt_xent.py of the repository https://github.com/sthalles/SimCLR.
# It can be used for varying batch sizes unlike the original code.
...
# Because of the color jittering, a more random (and maybe more natural) distribution of colors is expected.
# Thus, the mean and standard deviation for ImageNet was assumed.
normalize = transforms.Normalize(
    mean=[0.485, 0.456, 0.406],
    std=[0.229, 0.224, 0.225]
)
# Random transformations are as follows:
...
class FineTune(torch.nn.Module):
    def __init__(self, ssl_model, out_dim=2):
	    ...
	    # ssl_model.classifier is sequential. We need its first layer.
