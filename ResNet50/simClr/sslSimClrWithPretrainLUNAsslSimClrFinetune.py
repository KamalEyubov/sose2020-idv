...
if __name__ == '__main__':
    ...
    path = 'model_backup/medical_transfer/ResNet50_SslSimClrWithPretrainLunaSslSimClr_train_covid_moco_covid.pt'
    model = resnet50()
    ...
    model.cuda()
    modelname = 'ResNet50'
    alpha = 'SslSimClrWithPretrainLunaSslSimClrFinetune'
